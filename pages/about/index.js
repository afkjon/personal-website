    ...
    <main>
      ...
      <section>
        ...
        <div className="container">
          <p className={styles.paragraph}>Hello, I&apos;m <strong>Jonathon Ho</strong>. I&apos;m a software developer based in Toronto and recent graduate of <strong>Computer Science</strong> at York University. My interests are in <strong>web development</strong>, both on the frontend and backend.</p>
